...
//
//	Um commit de outra sessão ("Fase 5: Inserir OC", 88aeee2) sobrescreveu
//	este arquivo com uma base bem mais antiga — sem Estatísticas, sem
//	Consolidação resolvida (voltou a ser "Balanço" em breve), sem Engenharia
//	nem SESMT e DP. Nada disso tinha sido apagado de propósito: o código de
//	cada módulo continuava intacto em `telas/` e `modulos/`, só a árvore
//	aqui é que regrediu. Este arquivo volta a ser a última versão boa
//	(376b5f3, já com Administrativo) — a única peça nova de fato adicionada
//	depois dela foi o tipo `'inserir-oc'`, que a tela `InserirOC.tsx` (essa
//	sim, legítima) já usa. Ver o mesmo comentário em App.tsx.
...
export type Tela =
  ...
  | 'consolidacao' | 'funcionarios' | 'servicos-hub' | 'obras' | 'inserir-oc' | 'ocs-inseridas'
